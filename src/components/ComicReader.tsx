...
import comicPage2 from "../assets/img1.png";
import comicPage3 from "../assets/img4.png";
import comicPage1 from "../assets/img6.png";
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center h-screen py-16 md:py-20 px-4 overflow-y-auto">
        ...
        {currentPage > 0 && (
          ...
          >
            <div className="relative w-[100px] h-[62px] md:w-[150px] md:h-[93px] lg:w-[200px] lg:h-[123px] rounded-3xl overflow-hidden opacity-30 hover:opacity-50">
              <img 
        ...
        <div className="relative w-full max-w-[340px] md:max-w-[440px] lg:max-w-[540px] aspect-[440/244] rounded-3xl overflow-hidden shadow-2xl">
          <img 
